...
4. To validate that your skill is working as expected, invoke your skill from the **Alexa Simulator**. You can either use the input box and type in the command to invoke or use your voice by clicking and holding the mic.
	- Type ```open``` followed by the invocation name you gave your skill in the [Voice User Interface](./1-voice-user-interface.md) step. For example, ```open mhack```.
	
	- Use your voice by clicking and holding the mic on the side panel and saying "Open" followed by the invocation name you gave your skill. If you've forgotten the invocation name for your skill, revisit the **Build** panel on the top navigation menu and select _Invocation_ from the sidebar to review it.
...
6. Configure a test event in AWS Lambda.
	Now that you are familiar with the **request** and **response** boxes in the Service Simulator, it's important for you to know that you can use your **requests** to directly test your Lambda function every time you update it.  To do this:
