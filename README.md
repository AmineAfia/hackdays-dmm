...
# Build a mhack Skill for Alexa
This tutorial will walk first-time Alexa skills developers through all the required steps involved in creating a feed reading skill using a template called ‘mhack’. Ask to play your feed and this skill will do so.
...
```text
Alexa, ask mhack to open first feed.
...
2. Simulate verbal interaction with your skill through the command line using the following example:
	...
	```bash
	 $ ask simulate -l en-US -t "start mhack"
